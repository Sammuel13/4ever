...
public class TelaIngressos extends javax.swing.JFrame {
    ...
    public TelaIngressos() {
        ...
        ingressos = new ListarIngressos();
        criar = new CriarIngresso();
        apagar = new ApagarIngresso();
    ...
    private ListarIngressos ingressos;
    private CriarIngresso criar;
    private ApagarIngresso apagar;

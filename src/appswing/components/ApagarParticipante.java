...
public class ApagarParticipante extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jFormattedTextField2
                .setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 2, 0, new java.awt.Color(255, 204, 0)));
        ...
        layout.setVerticalGroup(
                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(layout.createSequentialGroup()
                                ...
                                .addComponent(jFormattedTextField2, javax.swing.GroupLayout.PREFERRED_SIZE, 37,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(24, 24, 24)
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {// GEN-FIRST:event_jButton1MouseClicked
        ...
        try {
            ...
            jTextArea2.append("\n" + "Participante apagado com sucesso!");
            TelaPrincipal.output = jTextArea2.getText();
        } catch (Exception e) {
            jTextArea2.append("\n" + "Participante não pode ser apagado: " + e.getMessage());
            TelaPrincipal.output = jTextArea2.getText();
            return;
        }

 ...
 * @author anton
 */
public class ApagarParticipante extends javax.swing.JPanel {

    /**
     * Creates new form ApagarParticipantes
     */
    public ApagarParticipante() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Apagar Participante");
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        String input = jFormattedTextField2.getText();

        try {
            Fachada.apagarParticipante(input);
            jTextArea2.setText("Participante apagado com sucesso!");
        } catch (Exception e) {
            jTextArea2.setText("Participante não pode ser apagado: " + e.getMessage());
            return;
        }

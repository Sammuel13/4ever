 ...
 * @author anton
 */
public class ApagarIngresso extends javax.swing.JFrame {

    /**
     * Creates new form ApagarIngresso
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ApagarIngresso.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ApagarIngresso().setVisible(true);
            }
        });
    }
